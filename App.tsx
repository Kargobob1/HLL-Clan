    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-[var(--bg-deep)] text-[var(--text-main)] p-4 text-center relative overflow-hidden">
        ...
        <div className="glass-card p-6 md:p-10 max-w-2xl w-full border-t-4 border-t-[var(--accent)] relative z-10 animate-reveal">
          ...
          <p className="text-zinc-400 text-sm md:text-base mb-2 font-light leading-relaxed">
            Wir führen aktuell noch abschließende Aufarbeitungsmaßnahmen an unserer Infrastruktur durch.
          </p>
          <p className="text-zinc-500 text-xs md:text-sm mb-8 font-light leading-relaxed italic">
            Zudem haben wir proaktiv ein paar "Sicherheits-Empfehlungen" unseres Hosting-Providers umgesetzt und die Systeme einmal kräftig durchgelüftet. Es dauert nicht mehr lange!
          </p>
