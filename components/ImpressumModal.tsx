...
const ImpressumModal: React.FC<ImpressumModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-xl glass-card border-2 border-[var(--primary)] shadow-[0_0_50px_rgba(0,0,0,0.8)] overflow-hidden animate-in fade-in zoom-in duration-300">
        <div className="bg-[var(--primary)] p-4 flex justify-between items-center">
          <h2 className="font-oswald text-2xl font-bold text-[var(--accent)] tracking-widest uppercase italic">Impressum</h2>
          <button 
            onClick={onClose}
        ...
        <div className="bg-[var(--primary)]/10 p-4 border-t border-[var(--primary)]/30 text-center">
          <button 
            onClick={onClose}
            className="btn-primary px-10 py-2 font-oswald text-sm tracking-[0.2em] uppercase"
          >
            Schließen
          </button>
        </div>
