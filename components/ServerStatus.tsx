      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-zinc-400 mb-16 leading-relaxed max-w-2xl mx-auto font-light">
            Egal welches Spiel wir gerade dominieren (oder bei dem wir totalversagen) – unsere Infrastruktur steht. <br className="hidden md:block" /> 
          ...
          <div className="glass-card rounded-none p-6 md:p-12 mb-16 shadow-2xl relative group overflow-hidden border-t-4 border-t-[#facc15]">
            ...
            <div className="relative z-10">
                <div className="flex flex-col md:flex-row items-center justify-between gap-8 mb-12">
                  ...
                  <div className="text-center md:text-right">
                    <span className="text-[#facc15] text-3xl font-oswald tracking-[0.2em] font-bold uppercase text-glow-army">Live-Status</span>
                    <p className="text-zinc-500 text-[10px] tracking-[0.2em] uppercase mt-2 font-bold">Operation: Operativ</p>
                  </div>
                </div>

                {/* Server Banner Integration - Optimized Robust Container */}
                <div className="flex flex-col items-center justify-center w-full">
                  <div className="text-[10px] text-zinc-600 font-mono mb-4 uppercase tracking-[0.3em]">-- Monitor Start --</div>
                  <div className="relative w-full max-w-[560px] bg-[#0f110d] p-4 border-2 border-[#4b5320]/40 shadow-inner flex justify-center items-center min-h-[120px]">
                    <a 
            ...
            <div className="mt-8 bg-black/20 py-3 text-zinc-500 text-[9px] tracking-[0.4em] uppercase font-bold border-t border-white/5">
              Datenübertragung aktiv | HQ Signal stabil
            </div>
          </div>
