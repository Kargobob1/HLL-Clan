        ...
        <div className="max-w-4xl mx-auto bg-zinc-900 border border-zinc-800 p-12 rounded-2xl text-center shadow-2xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a 
              ...
              className="px-10 py-4 bg-orange-600 hover:bg-orange-700 text-white font-bold rounded-lg transition-all transform hover:-translate-y-1 flex items-center justify-center gap-3"
            >
